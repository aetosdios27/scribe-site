...
describe("FinalCta", () => {
  test("closes with the approved statement and public-alpha install action", () => {
    ...
    expect(html).toContain("install the public alpha");
    expect(html).toContain("Copy Scribe alpha bootstrap command");
